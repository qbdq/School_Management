# Generated by Django 4.0 on 2021-12-13 23:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('heure_debut', models.PositiveIntegerField(default=0)),
                ('heure_fin', models.PositiveIntegerField(default=0)),
                ('num_salle', models.PositiveIntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module_groupe', models.ManyToManyField(to='student_mangement.Module')),
            ],
            options={
                'db_table': 'Groupe',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adress_email', models.EmailField(max_length=70)),
                ...
                ('id_groupe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_mangement.groupe')),
                ('travail_etud', models.ManyToManyField(to='student_mangement.Travail_A_Rendre')),
            ],
            options={
                'db_table': 'etudiant',
            },
